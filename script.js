let currentIndex = 0;
const images = ["./assets/image/bb1.jpg", "./assets/image/bb2.jpg", "./assets/image/bb3.jpg", "./assets/image/bb4.jpg", "./assets/image/bb5.jpg", "./assets/image/bb6.jpg", "./assets/image/bb7.jpg", "./assets/image/bb8.jpg"];
const messages = [
    " I LOVE YOUR SMILE ",
            ...
            if (currentIndex === 0) {
                setTimeout(() => {
                    Swal.fire({
                        ...
                        imageUrl: "./assets/image/patrick.gif", // Replace with a cute image
                        imageWidth: 150,
                        imageHeight: 150,
                        background: "#C2B280",
                        color: "#d63384",
                        ...
                        Swal.fire({
                            ...
                            imageUrl: "./assets/image/me.gif", // Replace with a romantic image
                            imageWidth: 300,
                            imageHeight: 300,
                            background: "#C2B280",
                            color: "#d63384",
...
function playMusic() {
    let audio = new Audio("./assets/audio/Palagi.mp3"); // Replace with your song file
